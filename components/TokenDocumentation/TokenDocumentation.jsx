...
const TokenDocumentation = ({ onClose, isDarkMode }) => {
  ...
  const theme = {
    ...
    activeTab: isDarkMode ? "text-[#DE3657]" : "text-[#DE3657]",
    activeTabBorder: isDarkMode ? "bg-[#DE3657]" : "bg-[#DE3657]",
  ...
  const TabContent = {
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-[#DE3657]">15%</span>
              </div>
              <div className="flex items-center justify-between">
    ...
    roadmap: (
      <div className="space-y-12">
        <div>
          <h3 className="text-xl text-[#DE3657] mb-4">Phase 1 - Q1 2024</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
        ...
        <div>
          <h3 className="text-xl text-[#DE3657] mb-4">Phase 2 - Q2 2024</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
        ...
        <div>
          <h3 className="text-xl text-[#DE3657] mb-4">Phase 3 - Q3 2024</h3>
          <ul className={`space-y-2 ${theme.textSecondary}`}>
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <FaShieldAlt className="text-[#DE3657] w-6 h-6" />
              <div>
            ...
            <div className="flex items-center gap-4">
              <FaLock className="text-[#DE3657] w-6 h-6" />
              <div>

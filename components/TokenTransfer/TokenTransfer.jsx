...
const TokenTransfer = ({ isDarkMode }) => {
  ...
  const fetchBalances = async () => {
    ...
    try {
      ...
      // Format balances
      const formattedUsdtBalance = ethers.utils.formatUnits(
        usdtBalance,
        usdtDecimals
      );
        ...
        <div className="">
          ...
          <div className="mb-8">
            <p className={theme.textSecondary}>
              Send USDT, USDC, or any ERC20 token to another wallet address.
            </p>
          </div>
                ...
                {!isConnected ? (
                  ...
                  <div className="p-6">
                    ...
                    <form onSubmit={handleTransfer}>
                      {/* Stablecoin Selection (only visible in stablecoin tab) */}
                      {activeTab === "stablecoin" && (
                        <div className="mb-6">
                          <label
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="text-[#9761F4] text-sm hover:text-purple-300 mr-2"
                            >
                              MAX
                            </button>
                            <div
                          ...
                          <div>
                            ...
                            {transactionHash && (
                              <a
                                ...
                                className="text-[#9761F4] hover:text-purple-300 mt-2 inline-block"
                              >
                                View on Etherscan
                              </a>
                            )}
                      ...
                      >
                        <div className="flex justify-between items-center mb-2">
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[#9761F4] hover:text-purple-300 text-xs"
                          >
